    ...
    <div>
      <div className="doc-content">
        <div className="mb-1 flex items-center gap-2 text-sm text-slate-400">
          API reference <span>/</span> <code>{meta.sub}</code>
        </div>
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">{meta.title}</h1>
        <p>{meta.blurb}</p>
        <div className="not-prose mb-2 inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm dark:border-slate-800 dark:bg-slate-900">
